...
export interface GuardianResult {
  ...
  /** When verdict=block, an English search query the orchestrator should
   * open in the browser to actively guide the user to the alternative.
   * Comes from the policy's `suggested_search_query` field. */
...

{
  ...
  "suggestedSearchQuery": "نص بحث Google باللغة الإنجليزية للبديل (e.g. '7-Zip Mac download') — مأخوذ من حقل suggested_search_query في السياسة إن وُجد"
}
